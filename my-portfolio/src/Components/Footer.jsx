    ...
    <footer className="bg-black text-gray-400 py-6 pt-40 relative overflow-hidden">
      ...
      >
        ...
        <div className="rightside w-full md:w-1/2 flex flex-col items-center md:items-end gap-10">
            <div>
              <TiltedCard
                imageSrc={rohitImg}
                altText="Rohit Rajak"
                captionText="Rohit Rajak - Web Developer"
        ...
        <div className="flex gap-2 justify-center align-center">
          <SocialButton platform="linkedin" href="https://www.linkedin.com/in/irohitrajak/" tooltip="LinkedIn" />
          <SocialButton platform="github" href="https://github.com/irohitrajak" tooltip="GitHub" />
          <SocialButton platform="leetcode" href="https://leetcode.com/u/irohitrajak/" tooltip="LeetCode" />
          <SocialButton platform="instagram" href="https://www.instagram.com/iohitrajak/" tooltip="Instagram" />
          <SocialButton platform="whatsapp" href="https://wa.me/+918358847851?text=Hello Rohit!" tooltip="WhatsApp" />
        </div>
      </div>
      </div>
